...
# ╔═╡ 37ec3dec-670a-11ee-1a2b-cfded2f4d4b6
begin
	using Flux
	using BSON
	using MLJDecisionTreeInterface, MLJ, DataFrames, DecisionTree, CSV, CategoricalArrays
	RF_model = BSON.load("trained_RF.BSON")
end

# ╔═╡ 4a58b934-a887-46e4-ba7b-85bc70c4767a
using Dash, DashHtmlComponents, DashCoreComponents

# ╔═╡ dd0dfe76-fc33-4a51-ada1-ebd1e704e50f
md"
##### This is a dash board to do the prediction. 
Input the values of various attributes, and you will receive a prediction: benign or malignant.
"

# ╔═╡ 8bd0679d-d951-4f14-bfc3-8d76e1e60a88
md"
Load the trained random forest model.
"

# ╔═╡ 92e303d2-b278-40ef-820d-9802fdf8b713
md"
Do the dash board.
"

# ╔═╡ ac70b36c-dc55-4d1a-a0e6-a3c352d016b7
begin
	
app = dash()
app.layout = html_div(
    [
		html_h2("Interface of Heart Disease Diagnosis"),

		html_h4("Please fill the measurement results into the corresponding table."),
		
		dcc_input(id="age", type="number", placeholder="age: 0-100"),
		...
		dcc_input(
            id="trestbps", type="number",
            placeholder="trestbps: 50-250"),

		dcc_input(
            id="chol", type="number",
            placeholder="chol: 50-700"),

		dcc_input(
            id="fbs", type="number",
            placeholder="fbs: 0 or 1"),

		dcc_input(
            id="restecg", type="number",
            placeholder="restecg: 0 or 2"),

		dcc_input(
            id="thalach", type="number",
            placeholder="thalach: 50-250"),

		dcc_input(
            id="exang", type="number",
            placeholder="exang: 0 or 1"),

		dcc_input(
            id="oldpeak", type="number",
            placeholder="oldpeak: 0-7"),

		dcc_input(
            id="slope", type="number",
...
callback!(app,
    ...
    Input("ca", "value"),
	Input("thal", "value"),
) do v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13
	if nothing in [v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13] 
		result = nothing
		return "\nThe prediction is: \nNone"
	else
		dfff = DataFrame(age=[Float64(v1)], sex=[Float64(v2)], cp=[Float64(v3)], trestbps=[Float64(v4)], chol=[Float64(v5)], fbs=[Float64(v6)], restecg=[Float64(v7)], thalach=[Float64(v8)], exang=[Float64(v9)], oldpeak=[Float64(v10)], slope=[Float64(v11)], ca=[Float64(v12)], thal=[Float64(v13)])
		result = predict_mode(RF_model[:mach_final], dfff)
		return "\nThe prediction is: \n$(uppercase(String(result[1])))"
	end
end
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "2823877f06dd387cf74568ea0285bf53d387eb4f"
...
git-tree-sha1 = "39f892f27cf202b9accc487de9e2defaf07bc827"
uuid = "1b08a953-4be3-4667-9a23-3db579824955"
version = "1.3.0"

[[deps.DashBase]]
deps = ["JSON3", "Test"]
git-tree-sha1 = "b35fa92abd74d4beece57b8cab343aadacc417e4"
