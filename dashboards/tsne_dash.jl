...
# ╔═╡ 707c1b20-f507-4c33-9745-2da5a82a4993
using DataFrames, CSV, Random, StatsPlots, MLJ, TSne

# ╔═╡ 354eb933-2ed0-4a78-83dc-20343a2ddf73
using PlutoUI, HypertextLiteral

# ╔═╡ a0640fc0-689b-11ee-195c-4d9ca517d821
md"
#### Dash-board for visualization of influence of the number of neighboors considered in t-SNE
"

# ╔═╡ 10036d5d-a134-49ae-8bdf-34b346721d4b
data_tr = CSV.read("data_clev.csv", DataFrame)

# ╔═╡ 75fb46c5-2075-46f5-83da-e217de3e0f61
begin
	X = data_tr[:,1:13]
	stand1 = Standardizer()
...
# ╔═╡ 2f16f286-1516-4cb3-95b6-2338529c7d60
begin
	slider = @bind num PlutoUI.combine() do Child
		md"""
		##### This is to show t-SNE with different number of neighboors considered

		###### The number of neighboors considered is  
		
		$(
			Child(Slider(1:1:50; show_value=true))
		).

		###### Comment:
		When using 1 neighboor, it is not enough to distinguish the areas of begnin and malignant cases. With 2 or more neighboors considered, it is possible to largely seperate begnin and malignant cases in different areas. In addition, with more neighboors considered, the data points t-SNE-mapped tend to become more dispersed.
		"""
	end
	
end

# ╔═╡ a2e089de-a94f-4abf-aaaf-6141a595e407
begin
	#@info PlutoRunner.currently_running_cell_id
	embedding1 = tsne(Matrix(X1), 2, 5, 2000, num[1])
	plot_tsne = scatter(embedding1[:,1], embedding1[:,2], color=category_binary, label="", title="t-SNE: Red for malignant blue for begnin")
end

# ╔═╡ a0202166-39a1-499d-94a7-bf6da1cc5a70
begin
	@info PlutoRunner.currently_running_cell_id
	PlutoUI.ExperimentalLayout.hbox([slider, plot_tsne])
end

# ╔═╡ 6cc5b650-5dac-47cc-a28f-adbb0069c8a5
notebook = PlutoRunner.notebook_id[] |> string

# ╔═╡ 5226d8af-db9a-4602-9b6d-e8ac697f4353
celllist=["a0202166-39a1-499d-94a7-bf6da1cc5a70"]

# ╔═╡ 9364bb66-f13c-44d1-97f4-275e7a89a3aa
dash_final_url="http://localhost:1234/edit?" * "id=$notebook&" * join(["isolated_cell_id=$cell" for cell in celllist], "&")

# ╔═╡ 2d39e3ce-536b-4156-bda3-68b50b8c8f9b
@htl("""
<a href="$dash_final_url" style="font_size=20%">Click here for the Dashboard</a>
""")

# ╔═╡ 77950c56-652e-4276-8d9d-a9fcebf358f5
md"
###### Comment:
When using 1 neighboor, it is not enough to distinguish the areas of begnin and malignant cases. With 2 or more neighboors considered, it is possible to largely seperate begnin and malignant cases in different areas. In addition, with more neighboors considered, the data points t-SNE-mapped tend to become more dispersed.
"
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "b271a4ebb41de030586946d76adb827ccdbe0fca"
